...
/**
 * Cloud-ready JSON input stream that works with InputStream instead of File.
 * This allows reading from classpath resources without creating temporary files.
 */
