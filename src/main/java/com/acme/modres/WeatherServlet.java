...
public class WeatherServlet extends HttpServlet {
   ...
   * Previously used IBM WebSphere-specific ServerName API which is not available
   * in standard Java 17 environments.
   */
  ...
  private InitialContext setInitialContextProps() {
    ...
    // Updated raw Hashtable to use generics for Java 17 compatibility
