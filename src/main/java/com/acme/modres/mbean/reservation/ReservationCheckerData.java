...
public class ReservationCheckerData {
  ...
  // Updated from java.util.Date to java.time.LocalDate for Java 17 compatibility
  ...
  public boolean setSelectedDate(String dateStr) {
    try {
      // Updated from SimpleDateFormat to DateTimeFormatter for thread-safety and Java 17 compatibility
