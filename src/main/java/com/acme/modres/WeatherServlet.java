...
public class WeatherServlet extends HttpServlet {
  ...
  public void init() {
    ...
    try {
      ...
      logger.warning("Failed to initialize AWS Secrets Manager, falling back to environment variable: " + e.getMessage());
      this.cachedWeatherApiKey = System.getenv(WEATHER_API_KEY_ENV);
    }
  }
  ...
  private String getWeatherApiKeyFromSecretsManager() {
    try {
      ...
      // If the secret is a JSON string, parse it. For simplicity, assuming it's a plain string.
